...
async (conn, mek, m, { from, reply }) => {
    const githubRepoURL = 'https://github.com/hissari-bacha/Hissari-Bacha';
...
> ${config.DESCRIPTION}`;
        ...
        await conn.sendMessage(from, {
            image: { url: config.MENU_IMAGE_URL || 'https://files.catbox.moe/qeq0cg.jpg' },
            ...
            contextInfo: { 
                ...
                forwardedNewsletterMessageInfo: {
                    ...
                    newsletterName: config.OWNER_NAME || 'HISSARI-BACHA-MD',
                    serverMessageId: 143
                }
            }
        }, { quoted: mek });
